...
export const intro: BiBlock = {
  ar: [
    'حي المنتزه الثانية هو الطرف الشمالي الشرقي لمدينة الإسكندرية. من طوسون حيث مقر الحي، إلى قرية الصيد بأبي قير عند مصب خليجها التاريخي، وصولًا إلى مصايف المعمورة على الكورنيش — يمتد الحي بين الحدائق الملكية غربًا والبحيرة شرقًا، وهو الجمع النادر بين حدائق قصور ملكية وشواطئ عامة وقرى صيد عاملة وأحياء سكنية جديدة.',
