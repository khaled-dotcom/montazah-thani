...
export const news: NewsItem[] = [
  {
    ...
    body: {
      ar: [
        'تواصل أجهزة حي المنتزه الثانية عمل نقطة التمركز الميداني بشارع ٢٥، والتي تعمل على مدار الساعة لضمان عدم عودة المخالفات التي سبقت إزالتها، ومنع تجدد تجمعات الباعة الجائلين بالشارع.',
  ...
  },
  {
    ...
    body: {
      ar: [
        'استجابت وحدة التدخل السريع بحي المنتزه الثانية لبلاغات طارئة وردت إليها، وشنت حملة فورية بمدينة أبو قير للتصدي لأعمال مخالفة قامت داخل النطاق.',
  ...
  },
  {
    ...
    body: {
      ar: [
        'كلفت المهندسة دعاء محمد عبد الرزاق، رئيس حي المنتزه الثانية، إدارة الحدائق بمواصلة أعمالها لرفع كفاءة المسطحات الخضراء بنطاق الحي.',
  ...
  },
  {
    ...
    body: {
      ar: [
        'وجهت المهندسة دعاء محمد عبد الرزاق، رئيس حي المنتزه الثانية، بتنفيذ حملة مسائية لازالة الإشغالات وللتصدي للتعديات على حرم الطريق العام بشوارع ٢٠ وشارع مدرسة حورس.',
